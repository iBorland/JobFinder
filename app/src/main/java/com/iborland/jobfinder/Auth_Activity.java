...
Класс - активити авторизации.
Эта активити открывается если при запуске приложения в локальной БД не хранится ID пользователя и зашифрованный пароль.
Здесь пользователь вводит логин и пароль от своего аккаунта, проверяется валидность введённых данных.
В случае если аккаунт с таким логином и паролем есть - ID и шифрованный пароль записываются в локальную базу.
